...
export default function Header({onHandleScrollToProjects, onHandleScrollToAbout, onHandleScrollToContact} : HeaderProps) {
  return (
    <header className="flex gap-x-[55%] sm:gap-x-[0%] items-center mt-4 sm:mb-10 w-full">
        ...
        <div className="hidden sm:flex justify-self-end self-center lg:gap-x-6 ml-auto mr-8 sm:mr-24">
            <AnimatedButton
              onClick={onHandleScrollToProjects} 
              padding="py-[1.5rem] px-[3.5rem]">Projekte</AnimatedButton>
            <AnimatedButton
              onClick={onHandleScrollToAbout} 
              padding="py-[1.5rem] px-[3.5rem]">Über mich</AnimatedButton>
            <AnimatedButton
