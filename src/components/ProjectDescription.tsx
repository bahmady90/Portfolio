  ...
  return (
    <div className="hidden relative sm:flex flex-col md:my-6 w-full md:w-96 self-center">
      ...
      <ul className="p-4 list-disc list-outside">
        <li className="mb-2 text-white text-[1rem]">{descriptionOne}</li>
        <li className="mb-2 text-white text-[1rem]">{descriptionTwo}</li>
        <li>
          <a
            target="_blank"
            ...
            href={href}
          >
            <span className="">Hier zur Github-Repo &rarr;</span>
          </a>
        </li>
      </ul>
    </div>
